...
public class Samples2 {
	...
	public void seven() {
		...
		int x = 10;
		for(int i = 0; i < 10; i++) { //for loop runs 10 times, but nothing is in it. So, the problem only exceutes 10*10 (equals 100)
	...
	public void eleven() {
		...
		//CASTING and TYPE CHANGING EXAMPLES
		System.out.println("");
		System.out.println("PRACTICE EXAMPLES OF CASTING");
		System.out.println("---------------------------------------");
		System.out.println((int) 3.0457458);
		System.out.println((long) 3.0);
