...
public class SampleSocketServer {
	...
	private void start(int port) {
		...
		try (ServerSocket serverSocket = new ServerSocket(port);
				Socket client = serverSocket.accept(); //***accept waits forever until someone connects to it (line 14)
			...
			String fromClient = "";
			String toClient = "";
			while (	(fromClient = in.readLine()  ) != null) {		//nested condition value, client is connected, waiting for messages or until it receives null
